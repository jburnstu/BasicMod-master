...
import sleepermod.SleeperMod;
import sleepermod.util.CardStats;
import sleepermod.util.TriFunction;
...
import static sleepermod.util.GeneralUtils.removePrefix;
import static sleepermod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return SleeperMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    SleeperMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
