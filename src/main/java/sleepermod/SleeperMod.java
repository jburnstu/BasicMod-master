...
import sleepermod.util.TextureLoader;
...
@SpireInitializer
public class SleeperMod implements
    ...
    public void receivePostInitialize() {
        ...
        addCustomScreen(new ForgottenPileViewScreen());
    }
...
//        BaseMod.addRelicToCustomPool((AbstractRelic)new WhiteNoiseMachine(),  CardColorEnum.SLEEPER);
    ...
    public void receiveEditColors() {
        BaseMod.addColor(CardColorEnum.SLEEPER, GREY,GREY,GREY,GREY,GREY,GREY,GREY, "sleepermod/images/badge.png", "sleepermod/images/badge.png", "sleepermod/images/badge.png", "sleepermod/images/badge.png", "sleepermod/images/badge.png", "sleepermod/images/badge.png", "sleepermod/images/badge.png", "sleepermod/images/badge.png", "sleepermod/images/badge.png");
...
//                .notPackageFilter(WardOff.class)
    ...
    public void receiveEditKeywords()
    {
        ...
        Gson gson = new Gson();
        String strings = loadJson("sleepermod/localization/eng/Keywords.json");
    ...
    private static String checkResourcesPath() {
        String name = SleeperMod.class.getName(); //getPackage can be iffy with patching, so class name is used instead.
        ...
        if (!resources.exists()) {
            throw new RuntimeException("\n\tFailed to find resources folder; expected it to be at  \"resources/" + name + "\"." +
                    ...
                    "\t\"private static final String resourcesFolder = checkResourcesPath();\"\n" +
                    "\tat the top of the " + SleeperMod.class.getSimpleName() + " java file.");
        }
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(SleeperMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
