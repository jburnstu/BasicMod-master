...
import sleepermod.cards.skills.SleeperDefend;
import sleepermod.cards.attacks.SleeperStrike;

import java.util.ArrayList;

import static sleepermod.SleeperMod.characterPath;
import static sleepermod.SleeperMod.makeID;

import sleepermod.cards.attacks.TossAndTurn;
import sleepermod.cards.skills.*;
...
public class MySleeperPlayer extends CustomPlayer {
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass SLEEPER;
    ...
    public MySleeperPlayer() {
        ...
        System.out.println("getLoadout call done with");
