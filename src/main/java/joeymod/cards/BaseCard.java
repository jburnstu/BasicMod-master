...
import joeymod.JoeyBasicMod;
import joeymod.util.CardStats;
import joeymod.util.TriFunction;
...
import static joeymod.util.GeneralUtils.removePrefix;
import static joeymod.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return JoeyBasicMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    JoeyBasicMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
